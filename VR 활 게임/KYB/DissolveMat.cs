...
public class DissolveMat : MonoBehaviour
{
    ...
    /// <summary> 오브젝트의 상단 위치와 하단 위치를 가져옮 </summary>
    /// <returns>상단 하단 위치</returns>
